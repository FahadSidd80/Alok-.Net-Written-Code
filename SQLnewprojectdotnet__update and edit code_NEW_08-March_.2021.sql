...
select * from userregistration where email='fahadsid8026@gmail.com' and password='fahad'

create proc sp_passwordchange
@id int,
@old varchar(50),
@new varchar(50)
as
begin 
	update userregistration set password=@new
	where uid=@id and password=@old
end
