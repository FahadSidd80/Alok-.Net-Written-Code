...
select* from student where id in (3,14)

select * from student where id not in (3,14)
...
select * from student where name like '%a_' or  name like '%a__'
...
select * from student where name like '_[f-m]'
