...
begin
	...
	begin
	update Employee set name=@name,age=@age,gender=@gender,country=@country,state=@state,city=@city,mobileno=@mobileno,email=@email,confirmemail=@confirmemail,password=@password,confirmpassword=@confirmpassword where empid=@empid
	end
